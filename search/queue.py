...
Note: Every unused element in the queue is made null. This helps with checking for overflow and underflow.
'''
#************************************************
...
class Queue():
    ...
    #--------------------------------------------
    # Insert, or enqueue items to queue
    #--------------------------------------------
    def enqueue(self, x):
        if self.is_full():
    ...
    #--------------------------------------------
    # Remove, or dequeue items from queue
    #--------------------------------------------
    def dequeue(self):
        if self.is_empty():
            ...
            x = self.Q[self.head]
            self.Q[self.head] = None # maintain assertion that unused values are null
